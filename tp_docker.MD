...
docker run -p 8080:80 react-hello:latest
...
**URL Dockerhub:**
```
https://hub.docker.com/r/gcpandora/react-hello
```

**Taille de l'image:** 92.7MB
...
**Note:** docker-slim n'est pas disponible sous Windows. Étape passée comme prévu.
